...
static int	is_argument_has_number(char *str)
{
	int	i;
...
static int	get_number(char *str, long *p_nb)
{
...
static int	is_valid_numbers(char *str, long *p_nb)
{
	if (!str || str[0] == '\0')
	{
...
static int	rest_parsing(t_container *content, char **av, long hold_number)
{
